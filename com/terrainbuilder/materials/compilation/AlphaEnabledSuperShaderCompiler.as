...
*/
package com.terrainbuilder.materials.compilation
{
	...
	/**
	 * AlphaEnabledSuperShaderCompiler is a compiler that generates shaders that perform both lighting and "effects" through methods.
	 * This is used by AlphaEnabledTextureMaterial.
	 */
	public class AlphaEnabledSuperShaderCompiler extends SuperShaderCompiler
	{
		
		use namespace arcane;

		/**
		 * Creates a new AlphaEnabledSuperShaderCompiler object.
		 * @param profile The compatibility profile used by the renderer.
		 */
		public function AlphaEnabledSuperShaderCompiler(profile:String)
		{
			super(profile);
		}
		 ...
		 */
		protected override function compileMethods():void
		{
