...
*/
package com.terrainbuilder.materials.methods
{
	...
	/**
	 * BasicDiffuseMethodProxy provides the default shading method for Lambert (dot3) diffuse lighting.
	 */
	public class BasicDiffuseMethodProxy extends BasicDiffuseMethod
	{
		...
		/**
		 * Creates a new BasicDiffuseMethodProxy object.
		 */
		public function BasicDiffuseMethodProxy()
		{
			super();
		}
		 ...
		 */
		arcane override function get useAmbientTexture():Boolean
		{
			return _useAmbientTexture;
		}

		arcane override function set useAmbientTexture(value:Boolean):void
		{
		 ...
		 */
		public override function generateMip(stage3DProxy:Stage3DProxy):void
		{
			if (_useTexture)
		 ...
		 */
		public override function get diffuseAlpha():Number
		{
			return _diffuseA;
		}
		
		public override function set diffuseAlpha(value:Number):void
		{
			_diffuseA = value;
		}
		 ...
		 */
		public override function get diffuseColor():uint
		{
			return _diffuseColor;
		}
		
		public override function set diffuseColor(diffuseColor:uint):void
		{
		 ...
		 */
		public override function get texture():Texture2DBase
		{
			return _texture;
		}
		 ...
		 */
		public override function get alphaThreshold():Number
		{
			return _alphaThreshold;
		}
		
		public override function set alphaThreshold(value:Number):void
		{
			if (value < 0)
				value = 0;
			else if (value > 1)
		 ...
		 */
		protected override function applyShadow(vo:MethodVO, regCache:ShaderRegisterCache):String
		{
		 ...
		 */
		arcane override function set shadowRegister(value:ShaderRegisterElement):void
		{
