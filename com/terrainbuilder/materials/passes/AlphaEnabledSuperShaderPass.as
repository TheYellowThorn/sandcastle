...
{
	import com.terrainbuilder.materials.compilation.AlphaEnabledSuperShaderCompiler;
	...
	/**
	 * AlphaEnabledSuperShaderPass is a shader pass that uses shader methods to compile a complete program. It includes all methods
	 * associated with a material.
	 *
	 * @see away3d.materials.methods.ShadingMethodBase
	 */
	public class AlphaEnabledSuperShaderPass extends SuperShaderPass
	{
		 ...
		 */
		public function AlphaEnabledSuperShaderPass(material:MaterialBase)
		{
			super(material);
		...
		{
			return new AlphaEnabledSuperShaderCompiler(profile);
